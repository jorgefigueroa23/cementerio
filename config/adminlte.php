...
return [
    ...
    */
    ...
    'logo' => '<b>SIS</b>Cementerio',
    'logo_img' => 'vendor/adminlte/dist/img/cementerioLogo.png',
    ...
    */
    ...
    'auth_logo' => [
        'enabled' => false,
        'img' => [
            'path' => 'vendor/adminlte/dist/img/cementerioLogo.png',
            'alt' => 'Auth Logo',
            'class' => '',
            'width' => 50,
            'height' => 50,
       ...
       /*  [
            ...
            'submenu' => [
                ...
                [
                    ...
                    'submenu' => [
                        [
                            'text' => 'REGISTRAR',
                            'url'  => 'admin/pabellones/create',
                        ],
                        [
                            'text' => 'LISTAR',
                            'url'  => 'admin/pabellones',
                        ],
                    ],
                ],
                [
        ...
        [
            ...
            'submenu' => [
                ...
                [
                    'text' => 'TRASLADOS',
                    'url'  => 'procesos/traslados',
                ],
                [
                    'text' => 'ENTERRADOS',
                    'url'  => 'procesos/enterrados',
                ],
            ],
        ],
        /* ['header' => 'labels'],
